import { I18NEXT_DEBUG_MODE } from 'app/shared/constants';
import i18next from 'i18next';

i18next.init({
  lng: 'en', // if you're using a language detector, do not define the lng option
  debug: I18NEXT_DEBUG_MODE,
  saveMissing: true,
  resources: {
    en: {
      translation: {
        ...
        next: 'Next',
        step_1_select_topic: 'Step 1: Select Categories',
        ...
        invalid_external_url: 'Invalid external URL, make sure the link is a valid URL.',
