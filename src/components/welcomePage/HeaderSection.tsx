...
const HeaderSection = () => {
  ...
  return (
    <header className="bg-[#eaf4f8] dark:bg-[#102735]">
      <nav className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-x-6 gap-y-3 px-5 py-5 sm:px-8 lg:px-10" aria-label="Main navigation">
        ...
        <div className="order-3 flex w-full items-center gap-5 border-t border-[#c7dce5] pt-3 text-sm md:order-none md:w-auto md:gap-8 md:border-0 md:pt-0 dark:border-white/15">
