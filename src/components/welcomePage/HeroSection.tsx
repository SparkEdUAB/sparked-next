...
import { FaBookOpen, FaUsers, FaGraduationCap, FaClock } from 'react-icons/fa';
    ...
    <>
      <section className="bg-sky-50 dark:bg-gray-900">
        <div className="relative min-h-[600px] flex items-center">
          ...
          {/* Content */}
          <div className="relative w-full px-6 mx-auto max-w-screen-lg">
            {' '}
            {/* Removed py-16 and added w-full */}
            <div className="place-self-center mr-auto md:w-[60%]">
              <h1 className="mb-6 max-w-2xl font-medium leading-none text-white text-7xl">Your digital library</h1>
      ...
      <section className="bg-gradient-to-b from-sky-50 to-white dark:from-gray-900 dark:to-gray-800">
        <div className="mx-auto max-w-screen-lg sm:py-16 lg:px-6">
          <div className="mb-8 max-w-screen-md lg:mb-16 mx-auto text-center">
            ...
            <p className="sm:text-xl">
              SparkEd is a digital library created for schools, offering a platform where educators can easily upload
              learning materials and students can access them anytime, anywhere. With SparkEd, users can read books,
              watch educational videos, making learning more flexible and accessible for everyone.
            </p>
          </div>
        </div>
        {/* Hero Title Area */}
        <div className="pt-2 pb-8 px-4 mx-auto max-w-screen-xl text-center pt-1">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
            Transform your educational institution with a modern digital library that brings together students,
            educators, and resources in one platform.
          </p>
        </div>
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-2 mb-16 justify-items-center max-w-4xl mx-auto">
            ...
            <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 hover:transform hover:scale-105 transition-transform duration-300 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Access textbooks, and educational materials anytime, anywhere. Support for multiple formats including
                PDFs, videos, and interactive content.
              </p>
            </div>
            ...
            <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 hover:transform hover:scale-105 transition-transform duration-300 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Foster collaboration between students and teachers with shared resources, discussion boards, and group
                study materials.
              </p>
            </div>
            ...
            <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 hover:transform hover:scale-105 transition-transform duration-300 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Provide round-the-clock access to educational resources. Support remote learning and flexible study
                schedules.
              </p>
            </div>
          </div>
