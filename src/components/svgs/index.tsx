...
export const CourseBasedSvgImage = ({ width = 100, height = 100 }: { width?: number; height?: number }) => (
  <Image src={BibliophileSvg} width={width} height={height} alt="" />
);
export const UniversitySvgImage = () => <Image src={UniversitySvg} width={100} height={100} alt="" />;
export const EducationSvgImage = () => <Image src={EducationSvg} width={100} height={100} alt="" />;
