...
import { T_CreateSubjectFields, T_SubjectFields, T_RawSubjectFields } from './types';
...
const useSubject = () => {
  ...
  const triggerEdit = async () => {
    ...
    router.push(getChildLinkByKey('edit', ADMIN_LINKS.subjects) + `?subjectId=${selectedSubjectIds[0]}`);
  };
